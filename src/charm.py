...
class FastapiDemoCharm(ops.CharmBase):
    ...
    def __init__(self, framework: ops.Framework):
        ...
        framework.observe(self.on["demo-server"].pebble_ready, self._on_pebble_ready)
    ...
    def _update_layer_and_restart(self) -> None:
        ...
        self.unit.status = ops.MaintenanceStatus('Updating Config: Assembling Pebble layers')
        try:
